...
public class ManagePageTest extends TestBase {
    ...
    @BeforeMethod
    public void beforeMethodManagePageTest() {
    ...
    public void DA_MP_TC014() {
        ...
        homePage = loginPage.login(repo, user2);
    ...
    public void DA_MP_TC016() {
        ...
        homePage.moveMouseToGlobalSetting();
        pagePopup = homePage.clickEditPage();
    ...
    public void DA_MP_TC017() {
        ...
        String warningDeleteMessage = "Can not delete page '" + newPageNameParent + "' since it has children page(s)";
        ...
        isExactALertMassage = homePage.isAlertMessageCorrect(confirmDeleteMessage);
        ...
        isExactALertMassage = homePage.isAlertMessageCorrect(warningDeleteMessage);
    ...
    public void DA_MP_TC020() {
        ...
        isExactALertMassage = homePage.isAlertMessageCorrect(wariningDeleteMessage);
        assertTrue(isExactALertMassage, "Alert warning message is not displayed as expected");
    ...
    public void DA_MP_TC022() {
        ...
        isExactALertMassage = pagePopup.isAlertMessageCorrect(wariningDeleteMessage);
        assertTrue(isExactALertMassage, "Alert warning message is not displayed as expected");

        Logger.info("Post-Condition");
        pagePopup.clickOKAlert();
        homePage = pagePopup.clickCancel();
        homePage.moveMouseToPage(newPageNameParent);
        homePage.clickChildPage(newPageNameParent, newPageNameChild1);
        homePage.moveMouseToGlobalSetting();
        homePage.clickDeletePage();
